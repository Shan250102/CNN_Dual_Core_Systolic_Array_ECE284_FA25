...
initial begin 
  ...
  for (kij=0; kij<9; kij=kij+1) begin  // kij loop
    ...
    case(kij)
     0: w_file_name = "weight_t/weight_kij0.txt";
     1: w_file_name = "weight_t/weight_kij1.txt";
     2: w_file_name = "weight_t/weight_kij2.txt";
     3: w_file_name = "weight_t/weight_kij3.txt";
     4: w_file_name = "weight_t/weight_kij4.txt";
     5: w_file_name = "weight_t/weight_kij5.txt";
     6: w_file_name = "weight_t/weight_kij6.txt";
     7: w_file_name = "weight_t/weight_kij7.txt";
     8: w_file_name = "weight_t/weight_kij8.txt";
    endcase
  ...
  ////////// Accumulation /////////
  out_file = $fopen("output_final.txt", "r"); 
  acc_file = $fopen("acc_final.txt","r"); 
